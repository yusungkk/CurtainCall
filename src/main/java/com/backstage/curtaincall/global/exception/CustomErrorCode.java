        ...
        public enum CustomErrorCode {
            ...
            DISCOUNT_OUT_OF_RANGE(HttpStatus.BAD_REQUEST, "할인 기간이 상품의 공연 기간을 벗어났습니다."),
            OVERLAPPING_DISCOUNT_PERIOD(HttpStatus.BAD_REQUEST, "동일한 상품에 중복된 할인 기간이 존재합니다."),
            INVALID_DISCOUNT_DATE(HttpStatus.BAD_REQUEST, "현재 날짜가 할인 기간에 포함되지 않습니다"),
